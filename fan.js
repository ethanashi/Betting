    ...
    while(true) {
            ...
            nbaOutput.forEach(n => {
                ...
                if(!checkArr(n)) {
                    ...
                    let statement = "Bet " + percent1 + " on " + bet1 + " for " + n[1][3][0] + " and " + percent2 + " on " + bet2 + " for " + n[1][2][0] + " for " + perenctage * 100  +" percent back!"
                    if(alreadySaid.includes(statement))  {
                        return
                    }
                    else {
                        console.log("Bet " + percent1 + " on " + bet1 + " for " + n[1][3][0] + " and " + percent2 + " on " + bet2 + " for " + n[1][2][0] + " for " + perenctage * 100  +" percent back! (Iteration " + iteration + ")");
            ...
            mensOutput.forEach(n => {
                if(!checkArr(n)) {
                    ...
                    z++;
                    menArr.push((1 / (Math.max(n[0][3][1], n[1][3][1])) + 1 / (Math.max(n[0][2][1], n[1][2][1]))));
                }
            })
            if(z === mensOutput.length) {
            // console.log(`None found for Mens Basketball (Lowest was ${Math.min(...menArr)})`);
            }
            iteration++;
    } 
